// Arrays allow us to store lists of data in a collection.
  ...
  let newYearsResolutions = ["Code more", "Stress less", "Move to another country"];
  ...
  months.pop(months[months.length-1]);
  console.log(months)
  ...
  function printDogNameUppercase(dogName) {
...
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////
  ...
  person.favoriteFoods = ["Mango", "Rice", "Chocolate"];
  ...
  console.log(dog.labrador.puppy.name);
